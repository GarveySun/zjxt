...
<form method="post" name="form1">
  <table align=center border="1" cellspacing="0" cellpadding="1" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" bgcolor="#F2FDFD" width="700">
    <tr bgcolor="#FF8080">
      <td colspan=4 align="center" class=topic>人力资源部二次审核</td>
    </tr>
...
%>
    ...
    <tr bgcolor="#FFFFFF" class=small>
      ...
      <td><textarea name="hrcontent" class="necessary" cols="64" rows="7" placeholder="复审意见"><%=rs("suggestion_hr")%></textarea>
      <span style="color:#666">请填写复审意见</span>
      </td>
    </tr>
...
<%end if%>
    <tr bgcolor="#ffefbf">
      <td align=center colspan=2><input type="submit" value="审 核" name="send" onClick="form1.action='/asp/step_hr/JK_editNews_hrfushen_tj.asp?newsid=<%=rs("newsid")%>';return checkvalue();">
