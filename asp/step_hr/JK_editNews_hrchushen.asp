...
<form method="post" name="form1">
  <table align=center border="1" cellspacing="0" cellpadding="1" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" bgcolor="#F2FDFD" width="646">
    <tr bgcolor="#FF8080">
      <td colspan=4 align="center" class=topic>奖惩单据人力资源部备案</td>
    </tr>
...
<%end if%>
    <tr bgcolor="#ffefbf">
      <td align=center colspan=2><input type="submit" value="备案通过" name="send" onClick="form1.action='JK_editNews_hrchushen_tj.asp?newsid=<%=rs("newsid")%>';return checkvalue();">
