...
<form action="role_addnew_tj.asp" method="post" name="form1">
  ...
  <table align=center border="1" cellspacing="0" cellpadding="1" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" bgcolor="#F2FDFD" width="605">
    ...
    <tr bgcolor="#FFFFFF" class=small>
      ...
      <td><input name="checkbox21" type="checkbox" id="checkbox21" value="1"></td>
    </tr>
    <tr bgcolor="#FFFFFF" class=small>
      <td align=right height="24">&nbsp;</td>
      <td height="24">工服审批单</td>
      <td><input name="checkbox22" type="checkbox" id="checkbox22" value="1"></td>
    </tr>
    <tr bgcolor="#FFFFFF" class=small>
      <td align=right height="24">管理：</td>
      <td height="24">修改密码</td>
      <td><input name="checkbox31" type="checkbox" id="checkbox31" value="1"></td>
    </tr>
    <tr bgcolor="#FFFFFF" class=small>
      <td align=right height="24">&nbsp;</td>
      <td height="24">角色管理</td>
      <td><input name="checkbox32" type="checkbox" id="checkbox32" value="1"></td>
    </tr>
    <tr bgcolor="#FFFFFF" class=small>
      <td align=right height="24">&nbsp;</td>
      <td height="24">用户管理</td>
      <td><input name="checkbox33" type="checkbox" id="checkbox33" value="1"></td>
    </tr>
        <tr bgcolor="#FFFFFF" class=small>
      <td align=right height="24">&nbsp;</td>
      <td height="24">修改单据</td>
      <td><input name="checkbox34" type="checkbox" id="checkbox34" value="1"></td>
    </tr>
 <tr> 
